...
describe('@ngx-meta/core:', () => {
  describe('MetaService', () => {
    ...
    it('is defined', inject([MetaService], (metaService: MetaService) => {
  ...
  describe('MetaService', () => {
    ...
    it('should be able to set meta tags using routes', fakeAsync(
      inject([Meta, Title], (meta: Meta, title: Title) => {
        ...
        router.navigate(['/']).then(() => {
          ...
          router.navigate(['/toothpaste']).then(() => {
    ...
    it('should be able to set the `title`', fakeAsync(
      inject([MetaService, Title], (metaService: MetaService, title: Title) => {
        const router = TestBed.get(Router);
    ...
    it('should throw if you attempt to set `title` through `setTag` method', inject([MetaService], (metaService: MetaService) => {
      expect(() => {
    ...
    it('should be able to set meta `description`', fakeAsync(
      inject([MetaService, Meta], (metaService: MetaService, meta: Meta) => {
        const router = TestBed.get(Router);
    ...
    it('should be able to do not set `og:locale:alternate` using routes w/o default settings & w/o `og:locale`', fakeAsync(
      inject([Meta, Title], (meta: Meta, title: Title) => {
        const settings = cloneDeep(defaultSettings);
  ...
  describe('MetaService w/callback', () => {
    it('should be able to set `title` w/`non-observable` callback', fakeAsync(
      inject([Title], (title: Title) => {
    ...
    it('should be able to set meta tags w/`promise` callback', fakeAsync(
      inject([Title], (title: Title) => {
        const callback = async (value: string) => Promise.resolve(value);
    ...
    it('should be able to set meta tags w/`observable` callback', fakeAsync(
      inject([Title], (title: Title) => {
        const settings = cloneDeep(testSettings);
        settings.callback = observableOf;
        const metaFactory = () => new MetaStaticLoader(settings);
