...
[![Linux build](https://travis-ci.org/ngx-meta/core.svg?branch=v0.2.x)](https://travis-ci.org/ngx-meta/core) [![Windows build](https://ci.appveyor.com/api/projects/status/github/ngx-meta/core?branch=v0.2.x&svg=true)](https://ci.appveyor.com/project/ngx-meta/core) [![coverage](https://codecov.io/github/ngx-meta/core/coverage.svg?branch=v0.2.x)](https://codecov.io/gh/ngx-meta/core) [![npm version](https://badge.fury.io/js/%40ngx-meta%2Fcore.svg)](https://www.npmjs.com/package/@ngx-meta/core)
...
## Prerequisites
This [v0.2.x] branch of **`@ngx-meta/core`** depends on `@angular v2.0.0` but it's highly recommended that you are running at least **`@angular v2.4.0`** and **`@angular/router v3.4.0`**. Older versions contain outdated dependencies, might produce errors.
